...
namespace MiniShopApp.WebUI.Models
{
    public class ProductModel
    {
        ...
        [Range(1, 50000, ErrorMessage = "Lütfen 1-50.000 arasında bir değer giriniz!")]
        public decimal? Price { get; set; }
        [Required(ErrorMessage = "Açıklama ismi zorunludur!")]
        [StringLength(500, MinimumLength = 20, ErrorMessage = "Ürün ismi 20-500 karakter uzunluğunda olmalıdır!")]
